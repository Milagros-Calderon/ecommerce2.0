...
class FrontEndController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories= Product::where('status','1')->orderBy('id','desc')->take(8)->get();
        ...
        return view('index', compact('services','categories','features','latests','tops','testimonials','languages'));
        // 'portfilos' lo quite de la linea de arriba entre 'testimonials' y 'languages'
    }
